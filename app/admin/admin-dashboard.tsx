...
function OrdersTable({ orders, onStatus, onDelete, onDispatch, zrExpressReady, busy }: { orders: Order[]; onStatus: (id: number, status: OrderStatus) => void; onDelete: (order: Order) => void; onDispatch: (order: Order) => void; zrExpressReady: boolean; busy: boolean }) {
