...
function OrdersTable({ orders, onStatus, onDelete, onDispatch, onRetrySheet, zrExpressReady, busy }: { orders: Order[]; onStatus: (id: number, status: OrderStatus) => void; onDelete: (order: Order) => void; onDispatch: (order: Order) => void; onRetrySheet: (order: Order) => void; zrExpressReady: boolean; busy: boolean }) {
