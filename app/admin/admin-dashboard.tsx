...
type Tab = "overview" | "analytics" | "meta" | "whatsapp" | "orders" | "products" | "import" | "store" | "delivery";
...
export default function AdminDashboard() {
  ...
  const navigation: [Tab, string, string][] = [["overview", "Vue d’ensemble", "⌂"], ["analytics", "Rentabilité", "◫"], ["meta", "Meta", "◎"], ["whatsapp", "WhatsApp", "◉"], ["orders", "Commandes", "▤"], ["products", "Produits", "◇"], ["import", "Import IA", "↧"], ["store", "Façade boutique", "✦"], ["delivery", "Livraison", "▣"]];
