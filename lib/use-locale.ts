...
const dictionary = {
  fr: {
    ...
    deliveryMode: "Mode de livraison", home: "À domicile", office: "Au bureau du transporteur", address: "Adresse complète", optionalAddress: "Adresse (facultatif)", note: "Note pour la livraison (facultatif)", chooseWilayaFirst: "Choisissez votre wilaya pour voir le prix de livraison.",
  ...
  en: {
    ...
    deliveryMode: "Delivery method", home: "Home delivery", office: "Carrier office", address: "Full address", optionalAddress: "Address (optional)", note: "Delivery note (optional)", chooseWilayaFirst: "Choose your wilaya to see the delivery price.",
  ...
  ar: {
    ...
    deliveryMode: "طريقة التوصيل", home: "إلى المنزل", office: "إلى مكتب شركة التوصيل", address: "العنوان الكامل", optionalAddress: "العنوان (اختياري)", note: "ملاحظة للتوصيل (اختياري)", chooseWilayaFirst: "اختاروا ولايتكم لمعرفة سعر التوصيل.",
